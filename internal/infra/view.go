...
import (
	...
	elem "github.com/rprtr258/flatnotes/internal/elem"
					...
					elem.Div(Props{Class: "mb-3"},
						append([]elem.Node{
							elem.Select(Props{Class: "bttn sort-select", "v-model": "sortBy"},
								fun.Map[elem.Node](func(option sortOption) elem.Node {
...
func page(content elem.Node) elem.Node {
	return elem.HTML(Props{Lang: "en", Class: "h-100"},
		elem.Head(nil,
			...
			elem.Style(Props{Type: "text/css"}, map[string]styles.Props{
				"a": {
					styles.Color:          "#007bff",
				...
				".form-control:focus": {
					...
					styles.BorderColor: "var(--colour-border)",
				},

				".bttn": {
					styles.Border:          "0",
					styles.BackgroundColor: "var(--colour-background)",
					styles.BorderRadius:    "4px",
					styles.Padding:         "4px 10px",
					styles.Color:           "var(--colour-text-muted)",
				},
				".bttn &:hover": {
					styles.BackgroundColor: "var(--colour-background-tint)",
					styles.Cursor:          "pointer",
					styles.Color:           "inherit",
				},
				".bttn svg": {
