...
var _params = struct {
	searchTerm, redirect, showHighlights, sortBy string
}{
	searchTerm:     "term",
	redirect:       "redirect",
...
const (
	sortOptionScore sortOption = iota
	sortOptionTitle
...
func vIf(predicate bool, node elem.Node) elem.Node {
	return fun.IF[elem.Node](predicate, node, elem.None())
}

func icon(icon string) elem.Node {
	switch icon {
	case "pencil-square":
		return elem.Raw(`<svg data-v-e58248="" viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="pencil square" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-pencil-square b-icon bi"><g data-v-e58248=""><path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"></path><path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"></path></g></svg>`)
	case "trash":
		return elem.Raw(`<svg data-v-e58248="" viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="trash" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-trash b-icon bi"><g data-v-e58248=""><path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"></path><path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path></g></svg>`)
	case "search":
		return elem.Raw(`<svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="search" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-search b-icon bi"><g><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"></path></g></svg>`)
	case "moon":
		return elem.Raw(`<svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="moon" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-moon b-icon bi"><g><path d="M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278zM4.858 1.311A7.269 7.269 0 0 0 1.025 7.71c0 4.02 3.279 7.276 7.319 7.276a7.316 7.316 0 0 0 5.205-2.162c-.337.042-.68.063-1.029.063-4.61 0-8.343-3.714-8.343-8.29 0-1.167.242-2.278.681-3.286z"></path></g></svg>`)
	case "box-arrow-right":
		return elem.Raw(`<svg data-v-1e2034="" viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="box arrow right" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-box-arrow-right b-icon bi"><g data-v-1e2034=""><path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"></path><path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"></path></g></svg>`)
	case "plus-circle":
		return elem.Raw(`<svg data-v-1e2034="" viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="plus circle" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-plus-circle b-icon bi"><g data-v-1e2034=""><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path><path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"></path></g></svg>`)
	default:
		return elem.Span(nil, elem.Text("&lt;icon:"+icon+"&gt;"))
	}
}

func searchInput() elem.Node {
	return elem.Form(Props{"v-on:submit.prevent": "search", Class: "w-100"},
		elem.Div(Props{Class: "input-group w-100"},
			elem.Input(Props{
				ID:          "search-input",
				Type:        "text",
				Class:       "form-control",
			...
			elem.Div(Props{Class: "input-group-append"},
				elem.Button(Props{Type: "submit", Class: "btn"}, icon("search")),
			),
		),
	)
}
...
func navBar(
	...
	azHref := _pathSearch + "?" + url.Values{
		_params.searchTerm:     []string{"*"},
		_params.sortBy:         []string{sortOptionTitle.String()},
		_params.showHighlights: []string{"false"},
	}.Encode()
	showLogOutButton := !fun.Contains(authType, config.AuthTypeNone, config.AuthTypeReadOnly)
	showNewButton := authType != config.AuthTypeReadOnly

	return elem.Div(Props{Class: "d-flex justify-content-between align-items-center mb-5 w-100"},
		// TODO: hide logo on index page
		// Logo
		elem.A(Props{Href: _pathHome, "@click.prevent": "navigate(_basePaths.home, $event)"},
			logo( /*:class="{ invisible: !showLogo }" responsive*/ ),
		),
		// Buttons
		elem.Div(Props{Class: "d-flex"},
			// Log Out
			vIf(showLogOutButton,
				elem.Button(Props{
					Type:     "button",
					Class:    "bttn",
					"@click": "$emit('logout')",
				}, icon("box-arrow-right"), elem.Text("Log Out")),
			),
			// New Note
			vIf(showNewButton,
				elem.A(Props{
					...
					"@click.prevent":    "navigate(_basePaths.new, $event)",
					"v-b-tooltip.hover": "",
				}, icon("plus-circle"), elem.Text("New")),
			),
			// Theme Toggle
			elem.Button(Props{
				Type:                "button",
				...
				"v-b-tooltip.hover": "",
			}, icon(fun.IF(darkTheme, "sun", "moon"))),
			// A-Z
			elem.A(Props{
				Class:               "bttn",
				Href:                azHref,
...
type searchResult struct {
	...
	titleHighlightsOrTitle string
	includesHighlights     bool
}
...
func newSearchResult(
	...
	return searchResult{
		...
		href:                   _pathNote + "/" + url.PathEscape(title),
		lastModified:           lastModified,
		titleHighlightsOrTitle: fun.IF(titleHighlights != "", titleHighlights, title),
		includesHighlights: titleHighlights != "" ||
			contentHighlights != "" ||
			len(tagMatches) > 0,
	}
}

func noteViewerEditor(
	authType config.AuthType,
	note internal.NoteContentResponseModel,
) elem.Node {
	editMode := false
	canModify := authType != config.AuthTypeReadOnly

	return elem.Div(Props{Class: "pb-4"},
		elem.Div(Props{Class: "d-flex flex-column h-100"},
			// Buttons
			elem.Div(Props{Class: "d-flex justify-content-between flex-wrap align-items-end mb-3"},
				// Title
				fun.IF(
					editMode,
					elem.Input(Props{
					...
					elem.H2(Props{
						Class: "title",
						Title: note.Title,
					}, elem.Text(note.Title)),
				),
				// Buttons
				elem.Div(Props{Class: "d-flex"},
					concat(
						fun.IF(canModify && !editMode, []elem.Node{
							// Edit
							elem.Button(Props{
								Type:                "button",
								Class:               "bttn",
								...
								"v-b-tooltip.hover": "",
							}, icon("pencil-square"), elem.Text("Edit")),
							// Delete
							elem.Button(Props{
								Type:     "button",
								Class:    "bttn",
								"@click": "deleteNote",
							}, icon("trash"), elem.Text("Delete")),
						}, nil),
						fun.IF(editMode, []elem.Node{
							// Cancel
							elem.Button(Props{
								Type:     "button",
								Class:    "bttn",
								"@click": "confirmCancelNote",
							}, icon("arrow-return-left"), elem.Text("Cancel")),
							// Save
							elem.Button(Props{
								Type:     "button",
								Class:    "bttn",
								"@click": "saveNote",
							}, icon("check-square"), elem.Text("Save")),
						}, nil),
					)...,
				),
			),
			...
			fun.IF(!editMode,
				elem.Div(Props{
					Class: "note note-viewer toastui-editor-contents",
					Style: `margin: 0;
...
font-family: Inter,sans-serif;`,
					...
					func() elem.Node {
						...
						_ = goldmark.New().Convert([]byte(note.Content), &sb)
				...
				// Editor
				elem.Div(Props{Class: "note flex-grow-1"},
					&elem.Element{
						Tag: "editor",
						Attrs: Props{
...
func viewLogin() elem.Node {
	//   data
	authType := config.AuthTypeNone

	// export { default } from "./App.js";
	return elem.Div(Props{Class: "container d-flex flex-column h-100"},
		// authType,
		// // class="flex-grow-1"
		elem.Div(Props{Class: "d-flex flex-column justify-content-center align-items-center"},
			logo( /*class="mb-5"*/ ),
			vIf(authType != config.AuthTypeNone,
				elem.Div(Props{Class: "d-flex flex-column justify-content-center align-items-center"},
					elem.Form(Props{
						Class:                 "login-form d-flex flex-column align-items-center",
						"v-on:submit.prevent": "login",
					},
						elem.Div(Props{Class: "mb-1"},
							// Username
							elem.Div(Props{Class: "mb-1"}, elem.Input(Props{
								ID:             "username",
								Type:           "text",
							...
							// 2FA
							vIf(authType == config.AuthTypeTOTP,
								elem.Div(Props{Class: "mb-1"}, elem.Input(Props{
									ID:             "totp",
									Type:           "text",
						...
						// Remember Me
						elem.Div(Props{Class: "mb-3 form-check"},
							elem.Input(Props{
								Type:      "checkbox",
							...
							elem.Label(Props{
								...
								For:   "rememberMe",
							}, elem.Text("Remember Me")),
						),
						// Button
						elem.Button(Props{Class: "bttn", Type: "submit"},
							icon("box-arrow-in-right"), elem.Text("Log In"),
						),
					),
				),
			),
...
func viewHome(
	...
	notes = fun.Subslice(0, maxNotes, notes...)
	...
	return elem.Div(Props{Class: "container d-flex flex-column h-100"},
		...
		// Home
		elem.Div(Props{Class: "home-view align-self-center d-flex flex-column justify-content-center align-items-center flex-grow-1 w-100"},
			logo( /*class="mb-3"*/ ),
			searchInput(
			// :initial-value="searchTerm"
			// class="search-input mb-4"
			),
			vIf(authType != config.AuthTypeReadOnly,
				elem.Div(nil,
					elem.Div(Props{Class: "justify-content-top recently-modified"},
						elem.Div(Props{Class: "d-flex flex-row align-items-start"},
							elem.Div(Props{Class: "d-flex flex-column align-items-center"},
								append([]elem.Node{
									elem.P(Props{Class: "mini-header mb-1"}, elem.Text("RECENTLY MODIFIED")),
								}, elem.TransformEach(
									notes,
									func(note internal.SearchResultModel) elem.Node {
										return elem.A(Props{
											Class:            "bttn",
											Href:             _pathNote + "/" + url.PathEscape(note.Note.Title),
											":key":           "note.title",
											"@click.prevent": "openNote(note.href, $event)",
										}, elem.Text(note.Note.Title))
									})...)...,
							),
							elem.Div(Props{Class: "d-flex flex-column align-items-center"},
								append([]elem.Node{
									elem.P(Props{Class: "mini-header mb-1"}, elem.Text("TAGS")),
								}, elem.TransformEach(
									tags,
									func(tag string) elem.Node {
										return elem.A(Props{
											Class:            "bttn",
											":key":           "tag",
											":href":          "tag",
...
func viewNote(note internal.NoteContentResponseModel) elem.Node {
	//   data
	//       noteTitle: null,
	authType := config.AuthTypeNone
	darkTheme := true
...
func viewSearch(
	...
	return elem.Div(Props{Class: "container d-flex flex-column h-100"},
		...
		// Search Results
		elem.Div(Props{Class: "flex-grow-1 search-results-view d-flex flex-column"},
			func() elem.Node {
				// data
				//   searchFailed: false,
				...
				sortBy := sortOptionScore
				showHighlights := true

				// computed
				sortByIsGrouped := sortBy == sortOptionTitle

				type resultGroup struct {
					name          string
					searchResults []searchResult
				}
				var resultsGrouped []resultGroup
				switch sortBy {
				case sortOptionTitle:
					resultsGrouped = func() []resultGroup {
						...
						notesGroupedDict := fun.GroupBy(
							func(searchResult searchResult) string {
								firstCharUpper := strings.ToUpper(string([]rune{[]rune(searchResult.title)[0]}))
								if fun.Contains(firstCharUpper, _alphabet...) {
						...
						notesGroupedArray := []resultGroup{}
						for name, results := range notesGroupedDict {
							slices.SortFunc(results, func(a, b searchResult) int {
								return cmp.Compare(a.title, b.title)
							})
							notesGroupedArray = append(notesGroupedArray, resultGroup{
								name: name,
				...
				return elem.Div(Props{Class: "mb-4 flex-grow-1"},
					// Input
					searchInput( /*:initial-value="searchTerm" class="mb-1"*/ ),
					// Controls
					elem.Div(Props{Class: "mb-3"},
						append([]elem.Node{
							elem.Select(Props{Class: "bttn sort-select", "v-model": "sortBy"},
								elem.TransformEach(sortOptions, func(option sortOption) elem.Node {
									return elem.Option(Props{
										Class:    "p-0",
										":key":   "option",
										":value": "option",
									}, elem.Text("Order: "+option.String()))
								})...,
							),
							elem.Button(Props{
								Type:     "button",
								...
								icon(fun.IF(showHighlights, "eye-slash", "eye")),
								elem.Text(fun.IF(showHighlights, "Hide", "Show")+" Highlights"),
							),
						},
							// Results
							elem.TransformEach(
								resultsGrouped,
								func(group resultGroup) elem.Node {
									return elem.Div(Props{
										Class:  fun.IF(sortByIsGrouped, "mb-5", ""),
										":key": "group.name",
									},
										append([]elem.Node{
											vIf(sortByIsGrouped,
												elem.P(Props{Class: "group-name"}, elem.Text(group.name)),
											),
										}, elem.TransformEach(
											group.searchResults,
											func(result searchResult) elem.Node {
												return elem.Div(Props{
													Class:  "bttn result" + fun.IF(showHighlights, " mb-3", ""),
													":key": "result.title",
												},
													elem.A(Props{
														Href:             result.href,
														"@click.prevent": "openNote(result.href, $event)",
													},
														elem.P(nil, elem.Text(fmt.Sprintf("%.5f", result.score))),
														elem.Div(Props{Class: "d-flex justify-content-between"},
															elem.P(Props{
																Class: "result-title",
															}, elem.Raw(result.titleHighlightsOrTitle)),
															elem.Span(Props{
																Class:               "last-modified d-none d-md-block",
																Title:               "Last Modified",
																"v-b-tooltip.hover": "",
															}, elem.Text(result.lastModified.String())),
														),
														vIf(showHighlights,
															elem.P(Props{
																Class: "result-contents",
															}, elem.Raw(result.contentHighlights)),
														),
														elem.Div(Props{"v-show": "showHighlights"},
															elem.TransformEach(
																result.tagMatches,
																func(tag string) elem.Node {
																	return elem.Span(Props{":key": "tag", Class: "tag mr-2"},
																		elem.Text("#"+tag))
																})...,
														),
													),
...
func page(content elem.Node) *elem.Element {
	return elem.Html(Props{Lang: "en", Class: "h-100"},
		elem.Head(nil,
			elem.Meta(Props{Charset: "UTF-8"}),
			elem.Meta(Props{HTTPequiv: "X-UA-Compatible", Content: "IE=edge"}),
			elem.Meta(Props{Name: "viewport", Content: "width=device-width, initial-scale=1, shrink-to-fit=no"}),

			elem.Link(Props{Rel: "apple-touch-icon", Href: "assets/apple-touch-icon.png", Sizes: "180x180"}),
			elem.Link(Props{Rel: "icon", Href: "assets/favicon-32x32.png", Sizes: "32x32"}),
			elem.Link(Props{Rel: "icon", Href: "assets/favicon-16x16.png", Sizes: "16x16", Type: "image/png"}),
			elem.Link(Props{Rel: "manifest", Href: "site.webmanifest"}),
			elem.Link(Props{Rel: "mask-icon", Href: "assets/safari-pinned-tab.svg", "color": "#F8A66B"}),
			elem.Link(Props{Rel: "shortcut icon", Href: "assets/favicon.ico"}),
			elem.Meta(Props{Name: "msapplication-TileColor", Content: "#2b5797"}),
			elem.Meta(Props{Name: "msapplication-config", Content: "assets/browserconfig.xml"}),
			elem.Meta(Props{Name: "theme-color", Content: "#F8A66B"}),

			elem.Title(nil, elem.Text("flatnotes")),

			elem.Style(Props{Type: "text/css"}, elem.Text(`
/*
...
body {
	--colour-brand: var(--orange-75);

	--colour-background: var(--neutral-99);
	--colour-background-elevated: var(--white);
	--colour-background-tint: var(--neutral-96);
	--colour-background-highlight: var(--blue-96);

	--colour-text: var(--neutral-20);
	--colour-text-muted: var(--neutral-60);
	--colour-text-very-muted: var(--neutral-80);

	--colour-shadow: var(--neutral-94);
	--colour-border: var(--neutral-94);
}

body.dark-theme {
	--colour-background: var(--neutral-15);
	--colour-background-elevated: var(--neutral-20);
	--colour-background-tint: var(--neutral-15);
	--colour-background-highlight: var(--neutral-60);

	--colour-text: var(--neutral-80);
	--colour-text-muted: var(--neutral-60);
	--colour-text-very-muted: var(--neutral-45);

	--colour-shadow: none;
	--colour-border: var(--neutral-45);
}
...
.ProseMirror{font-family:Open Sans,Helvetica Neue,Helvetica,Arial,나눔바른고딕,Nanum Barun Gothic,맑은고딕,Malgun Gothic,sans-serif;color:#222;font-size:13px;overflow-y:auto;overflow-X:hidden;height:calc(100% - 36px)}
.ProseMirror .placeholder{color:#999}
.ProseMirror-selectednode,.ProseMirror:focus{outline:none}
.html-block.ProseMirror-selectednode,table.ProseMirror-selectednode{border-radius:2px;outline:2px solid #00a9ff}
.toastui-editor-contents{margin:0;padding:0;font-size:13px;font-family:Open Sans,Helvetica Neue,Helvetica,Arial,나눔바른고딕,Nanum Barun Gothic,맑은고딕,Malgun Gothic,sans-serif;z-index:20}
.toastui-editor-contents :not(table){line-height:160%;box-sizing:content-box}
.toastui-editor-contents address,.toastui-editor-contents cite,.toastui-editor-contents dfn,.toastui-editor-contents em,.toastui-editor-contents i,.toastui-editor-contents var{font-style:italic}
.toastui-editor-contents strong{font-weight:700}
.toastui-editor-contents p{margin:10px 0;color:#222}
.toastui-editor-contents>div>div:first-of-type h1,.toastui-editor-contents>h1:first-of-type{margin-top:14px}
.toastui-editor-contents h1,.toastui-editor-contents h2,.toastui-editor-contents h3,.toastui-editor-contents h4,.toastui-editor-contents h5,.toastui-editor-contents h6{font-weight:700;color:#222}
.toastui-editor-contents h1{font-size:24px;line-height:28px;border-bottom:3px double #999;margin:52px 0 15px;padding-bottom:7px}
.toastui-editor-contents h2{font-size:22px;line-height:23px;border-bottom:1px solid #dbdbdb;margin:20px 0 13px;padding-bottom:7px}
.toastui-editor-contents h3{font-size:20px;margin:18px 0 2px}
.toastui-editor-contents h4{font-size:18px;margin:10px 0 2px}
.toastui-editor-contents h3,.toastui-editor-contents h4{line-height:18px}
.toastui-editor-contents h5{font-size:16px}
.toastui-editor-contents h6{font-size:14px}
.toastui-editor-contents h5,.toastui-editor-contents h6{line-height:17px;margin:9px 0 -4px}
.toastui-editor-contents del{color:#999}
.toastui-editor-contents blockquote{margin:14px 0;border-left:4px solid #e5e5e5;padding:0 16px;color:#999}
.toastui-editor-contents blockquote ol,.toastui-editor-contents blockquote p,.toastui-editor-contents blockquote ul{color:#999}
.toastui-editor-contents blockquote>:first-child{margin-top:0}
.toastui-editor-contents blockquote>:last-child{margin-bottom:0}
.toastui-editor-contents code,.toastui-editor-contents pre{font-family:Consolas,Courier,Apple SD 산돌고딕 Neo,Lucida Grande,Apple SD Gothic Neo,맑은 고딕,Malgun Gothic,Segoe UI,돋움,dotum,sans-serif;border:0;border-radius:0}
.toastui-editor-contents pre{margin:2px 0 8px;padding:18px;background-color:#f4f7f8}
.toastui-editor-contents code{color:#c1798b;background-color:#f9f2f4;padding:2px 3px;letter-spacing:-.3px;border-radius:2px}
.toastui-editor-contents pre code{padding:0;color:inherit;white-space:pre-wrap;background-color:transparent}
.toastui-editor-contents img{margin:4px 0 10px;box-sizing:border-box;vertical-align:top;max-width:100%}
.toastui-editor-contents table{border:1px solid rgba(0,0,0,.1);margin:12px 0 14px;color:#222;width:auto;border-collapse:collapse;box-sizing:border-box}
.toastui-editor-contents table td,.toastui-editor-contents table th{border:1px solid rgba(0,0,0,.1);padding:5px 14px 5px 12px;height:32px}
.toastui-editor-contents table th{background-color:#555;font-weight:300;color:#fff;padding-top:6px}
...
.toastui-editor-contents dir,.toastui-editor-contents menu,.toastui-editor-contents ol,.toastui-editor-contents ul{display:block;list-style-type:none;padding-left:24px;margin:6px 0 10px;color:#222}
.toastui-editor-contents ol{list-style-type:none;counter-reset:li}
.toastui-editor-contents ol>li{counter-increment:li}
.toastui-editor-contents ol>li:before,.toastui-editor-contents ul>li:before{display:inline-block;position:absolute}
.toastui-editor-contents ul>li:before{content:"";margin-top:6px;margin-left:-17px;width:5px;height:5px;border-radius:50%;background-color:#ccc}
.toastui-editor-contents ol>li:before{content:"." counter(li);margin-left:-28px;width:24px;text-align:right;direction:rtl;color:#aaa}
.toastui-editor-contents ol ol,.toastui-editor-contents ol ul,.toastui-editor-contents ul ol,.toastui-editor-contents ul ul{margin-top:0!important;margin-bottom:0!important}
.toastui-editor-contents ol li,.toastui-editor-contents ul li{position:relative}
.toastui-editor-contents ol p,.toastui-editor-contents ul p{margin:0}
.toastui-editor-contents hr{border-top:1px solid #eee;margin:16px 0}
.toastui-editor-contents a{text-decoration:underline;color:#4b96e6}
.toastui-editor-contents a:hover{color:#1f70de}
.toastui-editor-contents .image-link{position:relative}
.toastui-editor-contents .image-link:hover:before{content:"";position:absolute;width:30px;height:30px;right:0;border-radius:50%;border:1px solid #c9ccd5;background:#fff url(data:image/svg+xml;base64,) no-repeat;background-position:50%;box-shadow:0 2px 4px 0 rgba(0,0,0,.08);cursor:pointer}
.toastui-editor-contents .task-list-item{border:0;list-style:none;padding-left:24px;margin-left:-24px}
...
.toastui-editor-custom-block .toastui-editor-custom-block-editor{background:#f9f7fd;color:#452d6b;border:1px solid #dbd4ea}
...
.toastui-editor-custom-block .toastui-editor-custom-block-view .tool{position:absolute;right:10px;top:7px;display:none}
.toastui-editor-custom-block.ProseMirror-selectednode .toastui-editor-custom-block-view .tool{display:block}
.toastui-editor-custom-block-view button{vertical-align:middle;width:15px;height:15px;margin-left:8px;padding:3px;border:1px solid #ccc;background:url(data:image/svg+xml;base64,) no-repeat;background-position:50%;background-size:30px 30px}
.toastui-editor-custom-block-view .info{font-size:13px;font-weight:700;color:#5200d0;vertical-align:middle}
.toastui-editor-contents .toastui-editor-ww-code-block{position:relative}
.toastui-editor-contents .toastui-editor-ww-code-block:after{content:attr(data-language);position:absolute;display:inline-block;top:10px;right:10px;height:24px;padding:3px 35px 0 10px;font-weight:700;font-size:13px;color:#333;background:#e5e9ea url(data:image/svg+xml;base64,) no-repeat;background-position:100%;border-radius:2px;background-size:30px 30px;cursor:pointer}
.toastui-editor-ww-code-block-language{position:fixed;display:inline-block;width:100px;height:27px;right:35px;border:1px solid #ccc;border-radius:2px;background-color:#fff;z-index:30}
.toastui-editor-ww-code-block-language input{box-sizing:border-box;margin:0;padding:0 10px;height:100%;width:100%;background-color:transparent;border:none;outline:none}
.toastui-editor-contents-placeholder:before{content:attr(data-placeholder);color:grey;line-height:160%;position:absolute}
...
.toastui-editor-pseudo-clipboard{position:fixed;opacity:0;width:0;height:0;left:-1000px;top:-1000px;z-index:-1}
code[class*=language-],pre[class*=language-]{color:#000;background:none;text-shadow:0 1px #fff;font-family:Consolas,Monaco,Andale Mono,Ubuntu Mono,monospace;font-size:1em;text-align:left;white-space:pre;word-spacing:normal;word-break:normal;word-wrap:normal;line-height:1.5;-o-tab-size:4;tab-size:4;hyphens:none}
...
pre[class*=language-]{overflow:visible}
.toastui-editor-ww-code-block-highlighting{position:relative}
...
.toastui-editor-code-block-language{position:fixed;display:inline-block;right:35px;z-index:30}
.toastui-editor-code-block-language-input{position:relative;display:inline-block;padding:0 22px 0 10px;width:112px;height:26px;border:1px solid #ccc;border-radius:2px;background-color:#fff;cursor:pointer}
.toastui-editor-code-block-language-input input{margin:0;padding:0;height:100%;width:100%;background-color:#fff;color:#222;border:none;outline:none}
.toastui-editor-code-block-language-input input::placeholder{color:#ccc}
.toastui-editor-code-block-language .toastui-editor-code-block-language-input:after{
	content:url(data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAxMiAxNCI+PHBhdGggZmlsbC1ydWxlPSJldmVub2RkIiBjbGlwLXJ1bGU9ImV2ZW5vZGQiIGZpbGw9IiMyMjIiIGQ9Ik0yIDVoOGwtNCA1eiIvPjwvc3ZnPg==);
	position:absolute;
	display:inline-block;
	top:7px;
	right:5px;
...
.toastui-editor-code-block-language.active .toastui-editor-code-block-language-input:after{content:url(data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAxMiAxNCI+PHBhdGggZmlsbC1ydWxlPSJldmVub2RkIiBjbGlwLXJ1bGU9ImV2ZW5vZGQiIGZpbGw9IiMyMjIiIGQ9Ik0yIDloOEw2IDR6Ii8+PC9zdmc+)}
.toastui-editor-code-block-language-list{position:fixed;margin-top:-1px;width:144px;border:1px solid #ccc;border-bottom-left-radius:2px;border-bottom-right-radius:2px}
.toastui-editor-code-block-language-list .buttons{max-height:169px;overflow:auto;padding:0}
.toastui-editor-code-block-language-list button{width:100%;background-color:#fff;border:none;outline:0;padding:0 10px;font-size:13px;line-height:24px;text-align:left;color:#222;cursor:pointer}
.toastui-editor-code-block-language-list button.active{color:#4b96e6;font-weight:700}
.toastui-editor-code-block-language-list button:hover{background-color:#f4f7f8}
.toastui-editor-dark .toastui-editor-code-block-language-input input::placeholder{color:#eee}
.toastui-editor-dark .toastui-editor-ww-code-block-highlighting:after{background-color:#232428;border:1px solid #393b42;color:#eee;background-image:url(data:image/svg+xml;base64,)}
.toastui-editor-dark .toastui-editor-code-block-language span{border:1px solid #494c56;background-color:#121212}
.toastui-editor-dark .toastui-editor-code-block-language input{background-color:#121212;color:#eee}
.toastui-editor-dark .toastui-editor-code-block-language-list{box-shadow:0 2px 4px 0 rgba(0,0,0,.08);border:1px solid #494c56;border-radius:2px}
.toastui-editor-dark .toastui-editor-code-block-language-list button{color:#eee;background-color:#121212}
.toastui-editor-dark .toastui-editor-code-block-language-list button.active{color:#4b96e6}
.toastui-editor-dark .toastui-editor-code-block-language-list button:hover{background-color:#36383f}
.toastui-editor-dark .toastui-editor-code-block-language .toastui-editor-code-block-language-input:after{content:url(data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAxMiAxNCI+PHBhdGggZmlsbC1ydWxlPSJldmVub2RkIiBjbGlwLXJ1bGU9ImV2ZW5vZGQiIGZpbGw9IiNmZmYiIGQ9Ik0yIDVoOGwtNCA1eiIvPjwvc3ZnPg==)}
.toastui-editor-dark .toastui-editor-code-block-language.active .toastui-editor-code-block-language-input:after{content:url(data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAxMiAxNCI+PHBhdGggZmlsbC1ydWxlPSJldmVub2RkIiBjbGlwLXJ1bGU9ImV2ZW5vZGQiIGZpbGw9IiNmZmYiIGQ9Ik0yIDloOEw2IDR6Ii8+PC9zdmc+)}
.title{min-width:300px;height:1.5em;white-space:nowrap;text-overflow:ellipsis;overflow-x:hidden;margin:0}
.title,.title-input{color:var(--colour-text)}
.title-input{border:none;background-color:transparent;padding:0}
.title-input:focus{outline:none}
.note{background-color:var(--colour-background-elevated);box-shadow:0 0 10px var(--colour-shadow)}
.toastui-editor-defaultUI{border:none}
.toastui-editor-contents h1,.toastui-editor-contents h2,.toastui-editor-contents h3,.toastui-editor-contents h4,.toastui-editor-contents h5,.toastui-editor-contents h6,.toastui-editor-contents p,.toastui-editor-contents pre code{color:var(--colour-text)}
.toastui-editor-main,.toastui-editor-ww-container{background-color:var(--colour-background-elevated)}
.toastui-editor-contents dir,.toastui-editor-contents menu,.toastui-editor-contents ol,.toastui-editor-contents ul{color:var(--colour-text)}
.toastui-editor-contents pre,.toastui-editor-md-code-block-line-background{background-color:var(--colour-background-tint)}
.language-css .token.string,.style .token.string,.token.entity,.token.operator,.token.url{background:none}
.toastui-editor-contents table th{color:var(--colour-text);background-color:var(--colour-background-tint)}
.ProseMirror,.toastui-editor-contents table,.toastui-editor-md-table .toastui-editor-md-table-cell{color:var(--colour-text)}
.toastui-editor-defaultUI-toolbar,.toastui-editor-defaultUI .toastui-editor-md-tab-container{background-color:var(--colour-background-elevated);border-bottom-color:var(--colour-border)}
.toastui-editor-defaultUI .tab-item.active,.toastui-editor-mode-switch{background-color:var(--colour-background-elevated);border-color:var(--colour-border)}
.toastui-editor-defaultUI .tab-item.active{color:var(--colour-text)}
.toastui-editor-defaultUI .tab-item{background-color:var(--colour-background-tint);color:var(--colour-text-muted);border-color:var(--colour-border)}
.toastui-editor-md-tab-container .tab-item.active{border-bottom:none}
.toastui-editor-toolbar-divider{background-color:var(--colour-text)}
.dark-theme .toastui-editor-toolbar-icons{background-position-y:-49px}
.toastui-editor-defaultUI-toolbar button{border:1px solid var(--colour-background-elevated)}
.toastui-editor-defaultUI-toolbar button:not(:disabled):hover{background-color:var(--colour-background-tint);border:1px solid var(--colour-background-elevated)}
.toastui-editor-md-block-quote .toastui-editor-md-marked-text{color:var(--colour-text-muted)}
.toastui-editor-contents code,.toastui-editor-md-code{background-color:var(--colour-background-tint)}
.toastui-editor-popup{background-color:var(--colour-background-elevated);border:1px solid var(--colour-border)}
.toastui-editor-popup-body label{color:var(--colour-text)}
.toastui-editor-popup-body input{background-color:var(--colour-background-elevated);border:1px solid var(--colour-border)}
.toastui-editor-popup-add-table .toastui-editor-table-cell,.toastui-editor-popup-add-table .toastui-editor-table-cell.header{background-color:var(--colour-background-elevated);border-color:var(--colour-border)}
.toastui-editor-popup-add-heading ul li:hover{background-color:var(--colour-background-highlight)}
.toastui-editor-popup-add-image .toastui-editor-tabs .tab-item{color:var(--colour-text);background-color:var(--colour-background-elevated);border-color:var(--colour-border)}
.toastui-editor-popup-add-image .toastui-editor-file-name.has-file{color:var(--colour-text)}
.toastui-editor-popup-body input[type=text]{color:var(--colour-text);background-color:var(--colour-background-elevated)}
.toastui-editor-dropdown-toolbar{background-color:var(--colour-background-elevated)}
.toastui-editor-contents table td,.toastui-editor-contents table th,.toastui-editor-dropdown-toolbar{border-color:var(--colour-border)}
.toastui-editor-contents th p{color:var(--colour-text)}
.ProseMirror,.toastui-editor-contents{font-family:Inter,sans-serif}
.toastui-editor-contents{padding:min(2vw,30px) min(3vw,40px)}
.toastui-editor-contents h1,.toastui-editor-contents h2,.toastui-editor-contents h3,.toastui-editor-contents h4,.toastui-editor-contents h5,.toastui-editor-contents h6{border-bottom:none}
.toastui-editor-defaultUI .ProseMirror{padding:min(2vw,30px) min(3vw,40px)}
.toastui-editor-contents code,.toastui-editor-contents pre,.toastui-editor-md-code,.toastui-editor-md-code-block{font-family:Consolas,Lucida Console,Monaco,Andale Mono,monospace}
.note-viewer li.task-list-item{pointer-events:none}
.note-viewer li.task-list-item a{pointer-events:auto}
.mini-header{
	font-size:12px;
	font-weight:700;
...
@keyframes highlight-data-v-7ea6b1{
	0%{background-color:var(--colour-background-highlight)}
	to{background-color:var(--colour-background-elevated)}
}
.highlight{animation-name:highlight-data-v-7ea6b1;animation-duration:1.5s}
.btn{border:1px solid var(--colour-border)}
.btn svg{color:var(--colour-text-muted)}
#search-input{border-color:var(--colour-border)}
#search-input,#search-input:focus{background-color:var(--colour-background-elevated);color:var(--colour-text)}
#search-input::placeholder{color:var(--colour-text-muted)}
.sort-select{padding-inline:6px}
.group-name{padding-left:8px;font-weight:700;font-size:32px;color:var(--colour-text-very-muted);margin-bottom:8px}
.result p{margin:0}
.result-title{color:var(--colour-text)}
.last-modified{font-size:12px}
.last-modified,.result-contents{color:var(--colour-text-muted)}
.match{font-weight:700;color:var(--colour-brand)}
.tag{color:#fff;font-size:14px;background-color:var(--colour-brand);padding:2px 6px;border-radius:4px}
:root{
	--blue:#007bff;
	--indigo:#6610f2;
	--purple:#6f42c1;
	...
	--font-family-sans-serif:BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans","Liberation Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji";
...
.custom-control{position:relative;z-index:1;display:block;min-height:1.5rem;padding-left:1.5rem;color-adjust:exact;print-color-adjust:exact}
...
.popover{top:0;left:0;z-index:1060;max-width:276px;font-family:BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,Liberation Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;font-style:normal;font-weight:400;line-height:1.5;text-align:left;text-align:start;text-decoration:none;text-shadow:none;text-transform:none;letter-spacing:normal;word-break:normal;white-space:normal;word-spacing:normal;line-break:auto;font-size:.875rem;word-wrap:break-word;background-color:#fff;background-clip:padding-box;border:1px solid rgba(0,0,0,.2);border-radius:.3rem}
...
.spinner-border{display:inline-block;width:2rem;height:2rem;vertical-align:-.125em;border:.25em solid;border-right:.25em solid transparent;border-radius:50%;animation:spinner-border .75s linear infinite}
...
.b-avatar .b-avatar-custom,.b-avatar .b-avatar-img,.b-avatar .b-avatar-text{border-radius:inherit;width:100%;height:100%;overflow:hidden;display:flex;justify-content:center;align-items:center;mask-image:radial-gradient(#fff,#000)}
...
.b-skeleton{position:relative;overflow:hidden;background-color:rgba(0,0,0,.12);cursor:wait;mask-image:radial-gradient(#fff,#000)}
