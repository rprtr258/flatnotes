...
import (
	...
	textm "github.com/rprtr258/flatnotes/internal/goldmark/text"
)
...
func (n *Heading) Dump(source []byte, level int) {
	DumpHelper(n, source, level, map[string]string{
...
func (n *FencedCodeBlock) Dump(source []byte, level int) {
	m := map[string]string{}
	if n.Info != nil {
		m["Info"] = fmt.Sprintf("%q", n.Info.Text(source))
	}
...
const (
	HTMLBlockType1 HTMLBlockType = iota + 1 // HTMLBlockType1 represents type 1 html blocks.
	HTMLBlockType2                          // HTMLBlockType2 represents type 2 html blocks.
	HTMLBlockType3                          // HTMLBlockType3 represents type 3 html blocks.
	HTMLBlockType4                          // HTMLBlockType4 represents type 4 html blocks.
	HTMLBlockType5                          // HTMLBlockType5 represents type 5 html blocks.
	HTMLBlockType6                          // HTMLBlockType6 represents type 6 html blocks.
	HTMLBlockType7                          // HTMLBlockType7 represents type 7 html blocks.
)
...
type HTMLBlock struct {
	...
	HTMLBlockType HTMLBlockType // Type is a type of this html block.
	ClosureLine   textm.Segment // ClosureLine is a line that closes this html block.
}
...
func (n *HTMLBlock) Dump(source []byte, level int) {
	...
	if n.HasClosure() {
		fmt.Printf("%sClosure: \"%s\"\n", indent2, string(n.ClosureLine.Value(source)))
	}
	fmt.Printf("%s}\n", indent)
}
