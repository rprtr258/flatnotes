...
const (
	LeftSingleQuote  TypographicPunctuation = iota + 1 // LeftSingleQuote is '
	RightSingleQuote                                   // RightSingleQuote is '
	LeftDoubleQuote                                    // LeftDoubleQuote is "
	RightDoubleQuote                                   // RightDoubleQuote is "
	EnDash                                             // EnDash is --
	EmDash                                             // EmDash is ---
	Ellipsis                                           // Ellipsis is ...
	LeftAngleQuote                                     // LeftAngleQuote is <<
	RightAngleQuote                                    // RightAngleQuote is >>
	Apostrophe                                         // Apostrophe is '
)
